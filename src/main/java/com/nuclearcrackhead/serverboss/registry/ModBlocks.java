...
public class ModBlocks {
	...
	public static final Block ROOM_BLOCK = register("room_block", RoomBlock::new, AbstractBlock.Settings.create().requiresTool().strength(-1.0F, 3600000.0F).dropsNothing());

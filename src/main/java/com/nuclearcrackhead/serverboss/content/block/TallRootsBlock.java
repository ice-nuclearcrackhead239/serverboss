...
public class TallRootsBlock extends PlantBlock {
    public static final MapCodec<TallRootsBlock> CODEC = createCodec(TallRootsBlock::new);
    public static final EnumProperty<DoubleBlockHalf> HALF;

    public MapCodec<? extends TallRootsBlock> getCodec() {
        return CODEC;
    }

    public TallRootsBlock(AbstractBlock.Settings settings) {
        super(settings);
    ...
    protected BlockState getStateForNeighborUpdate(BlockState state, WorldView world, ScheduledTickView tickView, BlockPos pos, Direction direction, BlockPos neighborPos, BlockState neighborState, Random random) {
        ...
        if (direction.getAxis() != Axis.Y || doubleBlockHalf == DoubleBlockHalf.LOWER != (direction == Direction.UP) || neighborState.isOf(this) && neighborState.get(HALF) != doubleBlockHalf) {

...
public class ChainlinkBlock extends Block implements Waterloggable {
    public static final MapCodec<ChainlinkBlock> CODEC = createCodec(ChainlinkBlock::new);
    ...
    public MapCodec<ChainlinkBlock> getCodec() {
        return CODEC;
    }

    public ChainlinkBlock(AbstractBlock.Settings settings) {
        super(settings);
    ...
    private Map<BlockState, VoxelShape> getShapeMap(float f, float g, float h, float i, float j, float k) {
        ...
        float n = 1.0F - g;
        float o = 1.0F + g;
        VoxelShape voxelShape = Block.createCuboidShape((double)l, (double)0.0F, (double)l, (double)m, (double)h, (double)m);
        VoxelShape voxelShape2 = Block.createCuboidShape((double)n, (double)i, (double)0.0F, (double)o, (double)j, (double)o);
        VoxelShape voxelShape3 = Block.createCuboidShape((double)n, (double)i, (double)n, (double)o, (double)j, (double)16.0F);
        VoxelShape voxelShape4 = Block.createCuboidShape((double)0.0F, (double)i, (double)n, (double)o, (double)j, (double)o);
        VoxelShape voxelShape5 = Block.createCuboidShape((double)n, (double)i, (double)n, (double)16.0F, (double)j, (double)o);
        VoxelShape voxelShape6 = Block.createCuboidShape((double)n, (double)i, (double)0.0F, (double)o, (double)k, (double)o);
        VoxelShape voxelShape7 = Block.createCuboidShape((double)n, (double)i, (double)n, (double)o, (double)k, (double)16.0F);
        VoxelShape voxelShape8 = Block.createCuboidShape((double)0.0F, (double)i, (double)n, (double)o, (double)k, (double)o);
        VoxelShape voxelShape9 = Block.createCuboidShape((double)n, (double)i, (double)n, (double)16.0F, (double)k, (double)o);
    ...
    static {
        ...
        TALL_POST_SHAPE = Block.createCuboidShape((double)7.0F, (double)0.0F, (double)7.0F, (double)9.0F, (double)16.0F, (double)9.0F);
        TALL_NORTH_SHAPE = Block.createCuboidShape((double)7.0F, (double)0.0F, (double)0.0F, (double)9.0F, (double)16.0F, (double)9.0F);
        TALL_SOUTH_SHAPE = Block.createCuboidShape((double)7.0F, (double)0.0F, (double)7.0F, (double)9.0F, (double)16.0F, (double)16.0F);
        TALL_WEST_SHAPE = Block.createCuboidShape((double)0.0F, (double)0.0F, (double)7.0F, (double)9.0F, (double)16.0F, (double)9.0F);
        TALL_EAST_SHAPE = Block.createCuboidShape((double)7.0F, (double)0.0F, (double)7.0F, (double)16.0F, (double)16.0F, (double)9.0F);
    }
}

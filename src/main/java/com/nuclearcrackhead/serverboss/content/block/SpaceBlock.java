...
public class SpaceBlock<E extends BlockEntity> extends BlockWithEntity {
    //public static final Direction FACING = NORTH;
    protected final Supplier<BlockEntityType<? extends E>> entityTypeRetriever;

    public SpaceBlock(Settings settings, Supplier<BlockEntityType<? extends E>> entityTypeRetriever) {
        super(settings);

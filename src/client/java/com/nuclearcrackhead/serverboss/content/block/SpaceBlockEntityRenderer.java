...
public class SpaceBlockEntityRenderer implements BlockEntityRenderer<SpaceBlockEntity> {
    ...
    public static final Identifier TEXTURE = SVBCR.of("textures/block/___.png");
    public static final EntityModelLayer LAYER = new EntityModelLayer(SVBCR.of("shader_space"), "main");
    ...
    public SpaceBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
        ModelPart root = context.getLayerModelPart(LAYER);
        this.root = root;
    }

    public void render(SpaceBlockEntity blockEntity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        matrices.push();

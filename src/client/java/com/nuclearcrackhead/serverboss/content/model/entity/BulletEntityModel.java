...
public class BulletEntityModel extends EntityModel<BulletEntityRenderState> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData bb_main = modelPartData.addChild("bb_main", ModelPartBuilder.create().uv(2, 1).cuboid(0.0F, -1.0F, -1.0F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(-0.5F, 2.5F, 0.5F));
